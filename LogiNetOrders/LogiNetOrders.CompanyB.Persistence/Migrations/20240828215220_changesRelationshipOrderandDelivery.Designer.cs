...
namespace LogiNetOrders.CompanyB.Persistence.Migrations
{
    ...
    [Migration("20240828215220_changesRelationshipOrderandDelivery")]
    partial class changesRelationshipOrderandDelivery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogiNetOrders.CompanyB.Domain.LogiNetOrdersAggregate.Orders", b =>
                {
                    b.HasOne("LogiNetOrders.CompanyB.Domain.LogiNetOrdersAggregate.Delivery", "Delivery")
                        .WithOne("Order")
                        .HasForeignKey("LogiNetOrders.CompanyB.Domain.LogiNetOrdersAggregate.Orders", "DeliveryId")
                        .OnDelete(DeleteBehavior.Cascade);
